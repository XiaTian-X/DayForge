...
旧工作区：`/Users/xbase/workspace/DayForge`。
...
三个来源均具有本地 annotated tag `legacy-final-2026-09`。归档位于工作树外的 `/Users/xbase/workspace/DayForge-legacy-archive-2026-09-11`，其中 `root.bundle`、`android.bundle`、`backend.bundle` 已通过 `git bundle verify`；校验和记录在归档目录的 `MANIFEST.sha256`。
